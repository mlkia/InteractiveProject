...
namespace Interactive_Saga
{
    public class MessageHelper
    {
        ...
        public void RulesOfGame()
        {
            ...
            Console.WriteLine("The level will then continue with another Crossroad and so on, until you have correctly answered five questions.");
            Console.WriteLine("You will collect a randomized amount of Diamonds during your quest and use them to buy yourself clues.");
            Console.WriteLine("");
            Console.WriteLine("When you have outwitted the fifth character on each level you will obtain one of the three keys.");
